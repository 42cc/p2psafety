...
public class DelayedSosService extends Service {
    public static final String SOS_DELAY_START = "ua.p2psafety.DelayedSosService.TimerStart";
    public static final String SOS_DELAY_TICK = "ua.p2psafety.DelayedSosService.TimerTick";
    public static final String SOS_DELAY_FINISH = "ua.p2psafety.DelayedSosService.TimerFinish";
    public static final String SOS_DELAY_CANCEL = "ua.p2psafety.DelayedSosService.TimerCancel";
    public static final String SOS_DELAY_CHANGE = "ua.p2psafety.DelayedSosService.TimerChange";
