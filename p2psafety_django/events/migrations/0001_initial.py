...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'events_event', (
            ...
            ('PIN', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.create_table(u'events_eventupdate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 22, 0, 0))),
        ...
        db.send_create_signal(u'events', ['EventUpdate'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'events_eventupdate')
    ...
    models = {
        ...
        u'events.eventupdate': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
